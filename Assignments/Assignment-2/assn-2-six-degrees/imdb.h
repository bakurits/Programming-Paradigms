 ...
 * Method : getActor
 * ----------------------
 * This method finds Actors's data
 * For given pointer
 */
 ...
 * ----------------------
 * This method is compare function
 * For actors file
 */
